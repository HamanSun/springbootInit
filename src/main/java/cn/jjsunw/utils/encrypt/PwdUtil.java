package cn.jjsunw.utils.encrypt;
...
import cn.jjsunw.utils.FormatUtil;
...
public final class PwdUtil {
	 ...
	 * 字符串加密函数Bcry实现
	 */
	public final static String Bcrypt(String password) {
	...
	public final static boolean isSec(String password) {
		return FormatUtil.isMatche(password, SEC_PASSWORD);
	}
}
