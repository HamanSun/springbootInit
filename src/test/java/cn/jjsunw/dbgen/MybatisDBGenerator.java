...
import static cn.jjsunw.dbgen.DBGenConsts.*;
...
public class MybatisDBGenerator {
	...
	private static final String TEMPLATE_FILE_PATH = PROJECT_PATH + "/src/test/resources/dbgen/template";// template
																												// path
	...
	private static final String AUTHOR = "jjsunw";// @author
